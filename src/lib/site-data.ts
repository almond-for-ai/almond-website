      ...
      solo: {
        ...
        value: {
          ...
          slots: {
            ...
            cascade: {
              label: "The hand-off",
              title: "A retention bet became a loading spinner.",
              rows: [
                { name: "Decide", survived: "the retention bet · full intent", level: 0 },
                { name: "Prototype", survived: "make it load faster", level: 1 },
                { name: "Design", survived: "show something while it loads", level: 2 },
                { name: "Ship", survived: "added a loading spinner", level: 3 },
              ],
            },
          },
        },
